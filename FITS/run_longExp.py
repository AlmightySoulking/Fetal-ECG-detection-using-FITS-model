...
# Add the project's root directory (FITS-MAIN) to the Python path
# This gets the path of the current script and goes up two levels
project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
sys.path.append(project_root)

# Now you can import modules from any folder using the root as the base
from exp import exp_basic # Example: importing exp_basic.py from the exp folder
import argparse
import os
import torch
